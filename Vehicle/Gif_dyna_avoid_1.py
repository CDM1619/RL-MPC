# -*- coding: utf-8 -*-
"""
Created on Fri Dec 10 09:24:54 2021

@author: 86153
"""

#动态避障（每间隔一定step，障碍物位置会发生变化）
...
from CarCombat_dyna_avoid_1_test import CarCombatEnv
        ...
        if episode+1 == Episode:
           ...
           #画矩形用来画小车           
            ...
            for i in range(0,len(x_a)-1): 
                ...
                # #dpi较低                
                # plt.savefig('./graph/paper/Good Result/test_result_'+str(j_)+'/Gif/Trajectory%d.png'%i,bbox_inches = 'tight')

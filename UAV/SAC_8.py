...
config = {
    ...
    'max_episode': 500000,  # max episode
    'max_step': 200,  # fix 100 day
    'random_seed': True,  # False mean's fix seed [False,True]
    'seed': 1,  # fix seed
    # model RL
...
class SAC:
    def __init__(self, env):
        ...
        self.target_entropy = -(self.action_dim)     #原文中的目标熵      
